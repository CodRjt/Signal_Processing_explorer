# Create Real-life DSP Applications page
reallife_dsp_page_code = '''
...
# Save Real-life DSP page
with open('pages/5_🌍_Real_Life_DSP.py', 'w') as f:
    f.write(reallife_dsp_page_code)

print("✅ Created Real-life DSP Applications page")
print("File size:", len(reallife_dsp_page_code), "characters")